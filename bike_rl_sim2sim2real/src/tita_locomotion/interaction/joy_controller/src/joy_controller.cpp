...
namespace joy_controller
{
  ...
  void JoyCommand::joy_cb(const sensor_msgs::msg::Joy::SharedPtr msg)
  {
    ...
    *joy_msg_ = std::move(*msg);
    ...
    //           << joy_msg_->axes[5] << "\n6: "
    //           << joy_msg_->axes[6] << "\n7: "
    //           << joy_msg_->axes[7] << std::endl;
    // RCLCPP_INFO(this->get_logger(),"\nstart:\n");
    // RCLCPP_INFO(this->get_logger(),"0: %f",joy_msg_->axes[0]);
    // RCLCPP_INFO(this->get_logger(),"1: %f",joy_msg_->axes[1]);
    // RCLCPP_INFO(this->get_logger(),"2: %f",joy_msg_->axes[2]);
    // RCLCPP_INFO(this->get_logger(),"3: %f",joy_msg_->axes[3]);
    // RCLCPP_INFO(this->get_logger(),"4: %f",joy_msg_->axes[4]);
    // RCLCPP_INFO(this->get_logger(),"5: %f",joy_msg_->axes[5]);
    // RCLCPP_INFO(this->get_logger(),"6: %f",joy_msg_->axes[6]);
    // RCLCPP_INFO(this->get_logger(),"7: %f",joy_msg_->axes[7]);
  }

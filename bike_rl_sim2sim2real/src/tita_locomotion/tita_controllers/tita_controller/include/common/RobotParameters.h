...
struct RobotControlParameters
{
  RobotControlParameters(){
    ...
    joint_kp = {40.,10.,10.};
    joint_kd = {1.,0.5,0.5,};
    wheel_joint_name = {"joint_f_wheel", "joint_rear_wheel"};
  }
  scalar_t wheel_radius{0.33};
  ...
  std::string robot_description{"/usr/share/robot_description/bike/urdf/robot.urdf"};
  size_t dof_chassis{3}, dof_arm{0};
